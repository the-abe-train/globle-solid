export const German: Messages = {
  ...
  Game15: "{{guess}} grenzt fast an die Antwort!",
  Game16: "Nach Reihenfolge der Versuche sortieren",
  ...
  Settings16: "Rot",
  Settings17: "Blau",
  Settings18: "Regenbogen",
  Settings19: "Graustufen",
  ...
  Practice4: "Ja",
  Practice5: "Nein",
  q8: "8. Warum bekommen mein Freund und ich verschiedene Länder?",
  a8: "Manchmal erreichen Spielaktualisierungen nicht alle Browser/Geräte gleichzeitig. Um dieses Problem zu beheben, können Sie den neuesten Code durch ein erzwungenes Neuladen abrufen (Strg + Shift + R auf dem Desktop, Anweisungen variieren für mobile Geräte).",
  TWL1: "Verbinden Sie ein TWL-Konto für Statistik-Backup.",
  TWL2: "Mit Google anmelden",
  TWL3: "Mit Discord anmelden",
  TWL4: "Abonnieren Sie den Trainwreck Labs Newsletter.",
  TWL5: "Konto",
  TWL6: "Werbung entfernen",
  TWL7: "Club-Mitglied",
  TWL8: "Trennen",
  TWL9: "Gehen Sie zu Ihrem",
  TWL10: "Spielen Sie ein anderes Spiel von",
};
