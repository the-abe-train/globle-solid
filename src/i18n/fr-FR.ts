export const French: i18nMessages = {
  name: "Français",
  ...
  Aux1: `{{Click}} sur le globe pour jouer!`,
  Click: "Cliquez",
  Tap: "Appuyez",
  Aux2: "Vous avez une question?",
  Aux3: "Consultez la FAQ",
  Footer1: "Auteur: Trainwreck Labs",
  Footer2: "Le jeu vous plaît?",
  Footer3: "Trouvez TWL sur Discord",
  Loading: "Chargement...",
  FAQTitle: "FAQ",
  ...
  a2: `La section <a class="underline" href="/settings">Paramètres</a> contient un mode de jeu à contraste élevé.`,
  q3: "3. Qu'est-ce qui détermine la validité d'un pays dans le jeu?",
  a3: `Globle s'appuie sur cette <a class="underline" href="https://www.sporcle.com/blog/2013/01/what-is-a-country/">convention</a> afin de déterminer ce qui constitue une tentative valide.`,
  ...
  Settings12: "Les couleurs",
  Settings13: "Étiquettes activées",
  Settings14: "Étiquettes désactivées",
  Settings15: "Par défaut",
  Settings16: "Rouges",
  Settings17: "Bleus",
  Settings18: "Arc-en-ciel",
  Settings19: "Niveaux de gris",
  Game18: "Réponse",
  Practice1: "Vous êtes dans le mode entraînement.",
  Practice2: "Quitter le mode entraînement",
  Practice3: "Nouvelle partie d'entraînement",
  Game16: "Trier par ordre des tentatives",
  Game17: "Trier par distance",
  Practice4: "Oui",
  Practice5: "Non",
  q8: "8. Pourquoi mon ami et moi recevons-nous des pays mystères différents ?",
  a8: "Parfois, les mises à jour du jeu n'arrivent pas en même temps sur tous les navigateurs/appareils. Pour résoudre ce problème, vous pouvez obtenir le code le plus récent en effectuant un rechargement forcé (Ctrl + Shift + R sur un ordinateur de bureau, les instructions varient pour les appareils mobiles).",
  TWL1: "Connectez un compte TWL pour sauvegarder vos statistiques.",
  TWL2: "Se connecter avec Google",
  TWL3: "Se connecter avec Discord",
  TWL4: "Abonnez-vous à la newsletter de Trainwreck Labs.",
  TWL5: "Compte",
  TWL6: "Supprimer les publicités",
  TWL7: "Membre du club",
  TWL8: "Déconnecter",
  TWL9: "Accédez à votre",
  TWL10: "Jouer à un autre jeu de",
};
