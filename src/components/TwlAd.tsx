...
export default function () {
  ...
  return (
    <div>
      ...
      <form action={game().url} class="mx-auto block w-max p-2" target="_blank">
        ...
        <button class={`rounded ${game().bg} flex items-center border border-stone-500 px-2 py-1`}>
          <img src={game().logo} alt="Logo" width={25} height={20} class="h-max" />
